        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea class="form-control" validate="text" readonly rows="3" id="con_Motivo"></textarea>
                </div>
                <div class="form-group">
                    <label class="control-label">Sintomas</label>
                    <textarea class="form-control" validate="text" readonly rows="3" id="con_Sintomas"></textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Diagnostico</label>
                    <textarea class="form-control" validate="text" readonly rows="3" id="con_Diagnostico"></textarea>
                </div>
                <div class="form-group">
                    <label class="control-label">Prescripciòn</label>
                    <textarea class="form-control" validate="text" readonly rows="3" id="con_Prescripcion"></textarea>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="sv_id" data-id="0">
                <div class="form-group col-md-3">
                    ...
                    <input validate="text" type="text" class="form-control " readonly placeholder="kg - lb" id="sv_Peso">
                </div>
                <div class="form-group col-md-3">
                    <label class="form-control-label">Talla:</label>
                    <input validate="text" type="text" class="form-control " readonly placeholder="cm" id="sv_Talla">
                </div>
                <div class="form-group col-md-3">
                    <label class="form-control-label">Temp.:</label>
                    <input validate="text" type="text" class="form-control " readonly placeholder="ºC" id="sv_Temperatura">
                </div>
                <div class="form-group col-md-3">
                    <label class="form-control-label">F. Cardìaca:</label>
                    <input validate="text" type="text" class="form-control " readonly placeholder="x Min." id="sv_Frecuencia">
                </div>
                <div class="form-group col-md-3">
                    <label class="form-control-label">Presiòn Arterial:</label>
                    <input validate="text" type="text" class="form-control " readonly placeholder="mmHg" id="sv_Presion">
                </div>
